...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frameNewGesture = QFrame(self.frameButtons)
        self.frameNewGesture.setObjectName(u"frameNewGesture")
        self.frameNewGesture.setGeometry(QRect(0, 0, 521, 411))
    ...
    def retranslateUi(self, Form):
        ...
        self.lblGestureInputLabel.setText(QCoreApplication.translate("Form", u"Kiszolg\u00e1l\u00f3 c\u00edme", None))
