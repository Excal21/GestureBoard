...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.txtinputServer.setGeometry(QRect(223, 30, 267, 21))
        ...
        self.scrollArea.setGeometry(QRect(223, 140, 267, 181))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 265, 179))
        ...
        self.checkCloud.setGeometry(QRect(223, 80, 61, 22))
