...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btnBack.setGeometry(QRect(370, 340, 120, 40))
        self.btnSave = QPushButton(self.frameButtons)
        self.btnSave.setObjectName(u"btnSave")
        self.btnSave.setGeometry(QRect(240, 340, 120, 40))
        ...
        self.sliderSensitivity.setGeometry(QRect(180, 200, 271, 31))
        ...
        self.lblRadius.setGeometry(QRect(20, 270, 161, 30))
        ...
        self.sliderDrift = QSlider(self.scrollAreaWidgetContents)
        self.sliderDrift.setObjectName(u"sliderDrift")
        self.sliderDrift.setGeometry(QRect(180, 220, 271, 31))
        self.sliderDrift.setOrientation(Qt.Orientation.Horizontal)
        self.lblInvertButtons = QLabel(self.scrollAreaWidgetContents)
        self.lblInvertButtons.setObjectName(u"lblInvertButtons")
        self.lblInvertButtons.setGeometry(QRect(20, 280, 161, 30))
        self.checkInvertButtons = QCheckBox(self.scrollAreaWidgetContents)
        self.checkInvertButtons.setObjectName(u"checkInvertButtons")
        self.checkInvertButtons.setGeometry(QRect(430, 270, 21, 22))
        self.lblMouseSettings = QLabel(self.scrollAreaWidgetContents)
        self.lblMouseSettings.setObjectName(u"lblMouseSettings")
        self.lblMouseSettings.setGeometry(QRect(20, 220, 131, 30))
        self.sliderDriftOffset = QSlider(self.scrollAreaWidgetContents)
        self.sliderDriftOffset.setObjectName(u"sliderDriftOffset")
        self.sliderDriftOffset.setGeometry(QRect(180, 240, 271, 31))
        self.sliderDriftOffset.setOrientation(Qt.Orientation.Horizontal)
        self.lblDriftOffset = QLabel(self.scrollAreaWidgetContents)
        self.lblDriftOffset.setObjectName(u"lblDriftOffset")
        self.lblDriftOffset.setGeometry(QRect(20, 250, 131, 30))
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.btnStartCam = QPushButton(self.frameButtons)
        self.btnStartCam.setObjectName(u"btnStartCam")
        self.btnStartCam.setGeometry(QRect(30, 340, 141, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.lblSensitivity.setText(QCoreApplication.translate("Form", u"\u00c9rz\u00e9kenys\u00e9g", None))
        self.lblRadius.setText(QCoreApplication.translate("Form", u"Sodr\u00f3d\u00e1smentes z\u00f3na", None))
        ...
        self.lblInvertButtons.setText(QCoreApplication.translate("Form", u"Gombok felcser\u00e9l\u00e9se", None))
        self.checkInvertButtons.setText("")
        self.lblMouseSettings.setText(QCoreApplication.translate("Form", u"Eg\u00e9rm\u00f3d be\u00e1ll\u00edt\u00e1sai", None))
        self.lblDriftOffset.setText(QCoreApplication.translate("Form", u"Y eltol\u00e1s", None))
